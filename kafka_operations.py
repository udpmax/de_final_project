...
class KafkaData:
    ...
    def __init__(self):
        ...
        self.producer = kafka.KafkaProducer(bootstrap_servers='localhost:9091',  api_version=(0,10,5))
        self.consumer = kafka.KafkaConsumer('data', bootstrap_servers='localhost:9091',  auto_offset_reset='earliest', api_version=(0,10,5), consumer_timeout_ms= 6000)
